...
public class RenderLaserSource implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		...
		switch(l&3) {
			case 0:
				renderer.renderFaceZPos(Block.ice, x, y, z-f, laser);
				break;
			case 1:
				renderer.renderFaceXNeg(Block.ice, x+f, y, z, laser);
				break;
			case 2:
				renderer.renderFaceZNeg(Block.ice, x, y, z+f, laser);
				break;
			case 3:
				renderer.renderFaceXPos(Block.ice, x-f, y, z, laser);
				break;
		}
		if(world != null)
