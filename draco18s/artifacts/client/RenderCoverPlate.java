...
import draco18s.artifacts.block.PseudoCoverplate;
...
public class RenderCoverPlate implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		...
		if(Block.blocksList[wid] == null) {
			wid = Block.planks.blockID;
		}
		int meta = world.getBlockMetadata(x, y, z);
		Icon camo = Block.blocksList[wid].getIcon(l, meta);
	    y--;
		renderer.renderBlockUsingTexture(Block.blocksList[wid], x, y, z, camo);
		renderer.renderBlockUsingTexture(Block.ice, x, y, z, block.getIcon(0, 0));
