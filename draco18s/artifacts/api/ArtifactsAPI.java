...
public class ArtifactsAPI {
	 ...
	 */
	public static Attribute OnDeathAttribute = (new RangedAttribute("artifact.ondeath", 0.0D, 0.0D, 1.0D)).func_111117_a("Death Event").setShouldWatch(true);
	/**
	 * Apply these monster attributes with your components to get the event handler to detect that an effect is in effect.
	 * See an example segment in this java file.
	 */
	public static Attribute OnHurtAttribute = (new RangedAttribute("artifact.onhurt", 0.0D, 0.0D, 1.0D)).func_111117_a("Hurt Event").setShouldWatch(true);
